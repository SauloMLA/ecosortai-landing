...
export const en: Translations = {
  ...
  cta: {
    ...
    milestones: [
      ...
      { done: true,  label: "Hardware purchase & assembly" },
      { done: true,  label: "Real-world object validation" },
      { done: true,  label: "CAD design — NEMA 17 bowl gimbal" },
      { done: true,  label: "Public launch" },
    ],
